...
import de.codebuster.florian.popularmovies.ui.renderer.movies.MovieRendererAdapterFactory;
...
public class MoviesFragment extends BaseFragment implements MoviesPresenter.View {
    ...
    @Bind(R.id.popular_movies_grid) GridView movies_grid;
    @Bind(R.id.v_empty_case) View v_empty_case;
    @BindString(R.string.connection_error_message) String connectionErrorMessage;
    ...
    @Inject MovieRendererAdapterFactory movieRendererAdapterFactory;
    ...
    @Override public void renderMovies(final Collection<Movie> movies) {
        this.movies.clear();
    ...
    @Override public void showMovieTitleAsMessage(Movie movie) {
